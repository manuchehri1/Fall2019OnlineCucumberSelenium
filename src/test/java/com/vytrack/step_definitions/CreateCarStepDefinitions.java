...
public class CreateCarStepDefinitions {
    ...
    @Then("use click on create a car button")
    public void use_click_on_create_a_car_button() {
        System.out.println("use click on create a car button");
